...
import 'package:meso_programovil_final/pages/entradaSalida/editdata.dart';
...
class _DetailState extends State<Detail> {
  ...
  void deleteData() {
    var url = Uri.parse(
        'http://localhost:8080/PhpFluter/prueba/deleteDataEntradaSalida.php');
  ...
  void ReallyDelete() {
    AlertDialog alertDialog = AlertDialog(
      backgroundColor: const Color(0xfff0eadc),
      // shape: CircleBorder(),
      content: const Text("Seguro desea eliminar esta entrada o salida?"),
      actions: <Widget>[
        ElevatedButton(
            ...
            child: Center(
              child: Column(
                children: <Widget>[
                  ...
                  Text(
                    widget.list[widget.index]['entrada_salida'],
