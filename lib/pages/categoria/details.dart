...
import 'package:meso_programovil_final/pages/categoria/editdata.dart';
...
class _DetailState extends State<Detail> {
  ...
  void deleteData() {
    var url = Uri.parse(
        'http://localhost:8080/PhpFluter/prueba/deleteDataCategoria.php');
    //Aqui enviamos el parametro que es el id del registro que vamos a eliminar
    http.post(url,
        body: {'idCategoria': widget.list[widget.index]['idCategoria']});
  }
  ...
  void ReallyDelete() {
    AlertDialog alertDialog = AlertDialog(
      ...
      // shape: CircleBorder(),
      content: Text(
        "Seguro desea eliminar '${widget.list[widget.index]['nombre']}'",
      ),
      actions: <Widget>[
        ElevatedButton(
          ...
          onPressed: () {
            ...
            Navigator.of(context).push(MaterialPageRoute(
                builder: (BuildContext context) => const ListarCategoria()));
          },
          child: const Text(
            "Eliminar",
